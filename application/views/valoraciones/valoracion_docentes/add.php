...
<div class="card">
	...
	<div class="card-footer">
		<div class="form-group">
			...
			<textarea name="describo" class="form-control is-valid" rows="2" placeholder="Escriba aquí su comentario ..."  required></textarea>
		</div>

		<div class="form-group">
			<label for="exampleInputPassword1">Valoro: <a href="#"></a></label> <br>
			<textarea name="valoro" class="form-control is-valid" rows="2" placeholder="Escriba aquí su comentario ..." required></textarea>
		</div>

		<div class="form-group">
			<label for="exampleInputPassword1">Me pregunto: <a href="#"></a></label> <br>
			<textarea name="pregunto" class="form-control is-valid" rows="2" placeholder="Escriba aquí su comentario ..." required></textarea>
		</div>

		<div class="form-group">
			<label for="exampleInputPassword1">Sugiero: <a href="#"></a></label> <br>
			<textarea name="sugiero" class="form-control is-valid" rows="2" placeholder="Escriba aquí su comentario ..." required></textarea>
		</div>
