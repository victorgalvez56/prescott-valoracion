											...
											<td>
												<div class="btn-group">
													...
													<?php if ($permisovaloracion == "Leer") : ?>
														<button class="btn btn-info btn-lg"
																value="<?php echo $hijo->hijo_id; ?>"
																id="modal-valoracion1_leer" data-toggle="modal"
											...
											<td>
												<div class="btn-group">
													...
													<?php if ($permisovaloracion == "Leer") : ?>
														<button class="btn btn-info btn-lg"
																value="<?php echo $hijo->hijo_id; ?>"
																id="modal-valoracion2_leer" data-toggle="modal"
																data-target="#modal-leer-val"><span
																	class="fas fa-search"></span></button>
													<?php endif; ?>
												</div>
											...
											<?php if ($permisovaloracion == "Registrar") : ?>
												<td>
													<div class="btn-group">
														<button class="btn btn-warning btn-lg"
																value="<?php echo $hijo->hijo_id; ?>"
																id="modal-anedotario_registro" data-toggle="modal"
																data-target="#modal-anecdotario-val"><span
																	class="fas fa-edit"></span></button>
													</div>
												</td>
											<?php endif; ?>
...
<div class="modal fade" id="modal-leer-val">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-between">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-primary btn-print"><span class="fa fa-print"></span>Imprimir
				</button>
				<!--<button type="button" class="btn btn-primary">Save changes</button> -->
			</div>
		</div>
...
<div class="modal fade" id="modal-anecdotario-val">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><input type="button" value="Anecdotarios" id="titleValoracion"
											   class="btn btn-block bg-gradient-success btn-lg"></h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
