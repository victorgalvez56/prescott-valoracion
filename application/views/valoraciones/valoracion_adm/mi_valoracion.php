								...
								<div class="tab-pane active" id="tab_3">
									<section class="content">
													...
													<div class="timeline">
														...
														<div>
															...
															<div class="timeline-item">
																...
																<h3 class="timeline-header"><a href="#">Objetivos</a>
																</h3>
										...
										<div>
											...
											<div class="timeline-item">
												<span class="time"><i
															class="fas fa-clock"></i> <?php echo $estado->create_at ?></span>
												<h3 class="timeline-header no-border"><a
															href="#"><?php echo $estado->update_by ?></a> acepto tus
													objetivos</h3>
														...
														if ($estado_entrevista3_evalu[0]->ruta_firma_colab == null) {
															...
															if ($estado_entrevista3_evalu[0]->ruta_firma_evalu == null) {
																...
																<div>
																	...
																	<div class="timeline-item">
																		<h3 class="timeline-header no-border"><a
																					href="#"> El registro de valoración
																				por objetivos se ha terminado</a></h3>
																	</div>
																</div>
