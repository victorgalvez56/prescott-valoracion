				...
				<div class="card-body" style="display: block;">
					<dl class="row">
						<?php foreach ($puntajes1_val1 as $puntaje1) : ?>
							...
							<dt class="col-sm-4"> <input type="number" name="inputComunicacion[]" class="form-control indicadorComunicacion1"  min="1" max="4" value="<?php echo $puntaje1->puntaje; ?>" disabled>
							</dt>
						<?php endforeach; ?>
					</dl>
				</div>
				...
				<div class="card-body" style="display: block;">
					<dl class="row">
						<?php foreach ($puntajes2_val1 as $puntaje2) : ?>
							...
							<dt class="col-sm-4"> <input type="number" name="inputTrabajo[]" class="form-control indicadorTrabajosequipo1" min="1" max="4" value="<?php echo $puntaje2->puntaje; ?>" disabled>
							</dt>
						<?php endforeach; ?>
					</dl>
				</div>
				...
				<div class="card-body" style="display: block;">
					<dl class="row">
						<?php foreach ($puntajes3_val1 as $puntaje3) : ?>
							...
							<dt class="col-sm-4"> <input type="number" name="inputProactividad[]" class="form-control indicadorProactividad1" min="1" max="4" value="<?php echo $puntaje3->puntaje; ?>" disabled>
							</dt>
						<?php endforeach; ?>
					</dl>
				</div>
				...
				<div class="card-body" style="display: block;">
					<dl class="row">
						<?php foreach ($puntajes4_val1 as $puntaje4) : ?>
							...
							<dt class="col-sm-4"> <input type="number" name="inputAprendizaje[]" class="form-control indicadorAprendizaje1" min="1" max="4" value="<?php echo $puntaje4->puntaje; ?>" disabled>
							</dt>
						<?php endforeach; ?>
					</dl>
				</div>
