            ...
            <form action="<?php echo base_url(); ?>valoracion/mi_valoracion_adm/entrevista2_colab_registro" id="usrform" method="POST">
                <div class="card-body">
                    <div class="form-group">
                        <a href="#" rel="tooltip" data-placement="right" title="Tool tip with large text Tool tip with large text Tool tip with large text Tool tip with large text Tool tip with large text Tool tiasssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssp with large text" class="tt_large">Tooltip 2 with larger width</a>
