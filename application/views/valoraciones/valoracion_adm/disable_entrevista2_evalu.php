            ...
            <form action="<?php echo base_url(); ?>valoracion/mi_valoracion_adm/entrevista2_colab_registro" id="usrform" method="POST">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="a_obj_1" class="form-control is-warning" rows="2" placeholder="Enter ..." readonly><?php echo $estado_entrevista2_colab[0]->coment1_evalu; ?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="exampleInputPassword1">Comentario de <a href="#"><?php echo  $evaluador; ?></a></label>
                        <textarea name="a_obj_1" class="form-control is-warning" rows="2" placeholder="Enter ..." readonly><?php echo $estado_entrevista2_colab[0]->coment2_evalu; ?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="exampleInputPassword1">Comentario de <a href="#"><?php echo  $evaluador; ?></a></label>
                        <textarea name="a_obj_1" class="form-control is-warning" rows="2" placeholder="Enter ..." readonly><?php echo $estado_entrevista2_colab[0]->coment3_evalu; ?></textarea>
                    </div>
                </div>
