                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customRadio1" name="option1" value="1" disabled>
                            <label for="customRadio1" class="custom-control-label">Si</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customRadio2" name="option1" value="0" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="entrevista3_obj_1" class="form-control is-warning" rows="2" placeholder="Enter ..." disabled><?php echo $estado_entrevista3_evalu[0]->coment1_evalu; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for=""><a href="#"><?php echo $evaluador; ?></a> por favor registre su comentario.</label>
                        <textarea name="entrevista3_obj_2" class="form-control is-warning" rows="2" placeholder="Enter ..." disabled><?php echo $estado_entrevista3_evalu[0]->coment2_evalu; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customRadio5" name="option3" value="1" disabled>
                            <label for="customRadio5" class="custom-control-label">Si</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customRadio6" name="option3" value="0" disabled>
                    ...
                    <div class="form-group">
                        <label for=""><a href="#"><?php echo $evaluador; ?></a> por favor registre su comentario.</label>
                        <textarea name="entrevista3_obj_3" class="form-control is-warning" rows="2" placeholder="Enter ..." disabled><?php echo $estado_entrevista3_evalu[0]->coment3_evalu; ?></textarea>
                    </div>
                </div>
